...
| 파일 | 내용 | 좌측 소분류 메뉴 |
|---|---|---|
| `index.html` | 홈 — 히어로 슬라이드 + CTA 배너 | 없음 |
...
전송되는 구조였는데, 템플릿하우스 계정에 연결된 사이트에서만 동작하는
백엔드라 GitHub Pages 배포본에서는 작동하지 않습니다. 그래서 무료 서비스인
**Formspree**로 교체해뒀습니다.
...
추가로 오시는 길·개인정보 모달에도 들어있습니다. 파일마다 브라우저의
